...
public class LaberintoForks {
     ...
     * luego se llama a la función de Forks, para luego dar inicio a la resolución.
     ***
     */
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(new File(rutaArchivo))) {
            ...
            String[][] laberinto = new String[tamanio][tamanio];
            int i = 0;
            ...
            Forks tareaRaiz = new Forks(laberinto, inicioX, inicioY, tamanio, 1);
            ForkJoinPool pool = new ForkJoinPool();
            Boolean resultado = pool.invoke(tareaRaiz);
